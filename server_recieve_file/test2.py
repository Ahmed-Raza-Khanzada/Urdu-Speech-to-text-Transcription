...
import sys
print(os.getcwd())
from src.preprocess import Preporcess_Data  # Import your preprocessing class
...
preprocessor = Preporcess_Data(wavs_path="", char_to_num=char_to_num, frame_length=256, frame_step=160, fft_length=384, predict=True)
# Load Vocabulary
loaded_vocab = None
...
def transcribe_frames():
    with frames_lock:
        ...
        spectrogram = preprocessor.encode_single_sample('audio')
