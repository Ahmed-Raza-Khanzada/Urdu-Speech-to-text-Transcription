...
# tar_file_path = 'Dataset/cv-corpus-14.0-2023-06-23-ur.tar.gz'
# extract_dir = 'Dataset/'
...
data_path='Dataset/cv-corpus-14.0-2023-06-23/ur'
wavs_path = data_path + "/wav_files/"
metadata_path = data_path + "/train.tsv"
...
for i in range(len(metadata_df)):
    chars_vocab.update(metadata_df['normalized_transcription'][i])
